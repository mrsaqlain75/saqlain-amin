...
const milestones = [
  ...
  { id: 5,  year: "Jun 2023", label: "The Mentor Emerges",             sub: "First international online IT tutoring",   detail: "Online IT tutoring became part of the journey. Coached a US student through CompTIA A+ — first international student, first real impact.", side: "left"  },
  { id: 6,  year: "Aug 2023", label: "Academia Calls",                 sub: "Computer Science Lecturer, Chitral",      detail: "Appointed Computer Science Lecturer at a government college in Chitral. Officially trusted to shape the next generation.", side: "right" },
  { id: 7,  year: "Dec 2023", label: "The Stack Shift",                sub: "Android → MERN → Next.js",                detail: "Pivoted from Android to the MERN stack, then Next.js, TypeScript and Prisma. A calculated evolution, not a detour.", side: "left"  },
  ...
  { id: 11, year: "Dec 2025", label: "Community Impact",               sub: "50+ students trained in Chitral",         detail: "50+ students trained in web development and computer science across Chitral. IT education, multiplied.", side: "left"  },
  ...
  { id: 14, year: "May 2026", label: "Native Resort & Bamborate",      sub: "Full-stack booking & e-commerce",         detail: "Delivered a complex full-stack booking and e-commerce platform for Native Resort and Camping Bamborate.", side: "right" },
